...
plt.legend()
plt.savefig("../../data/figures/lora/comparison_val_acc.png")
plt.close()
...
plt.legend()
plt.savefig("../../data/figures/lora/comparison_time.png")
plt.close()
...
plt.legend()
plt.savefig("../../data/figures/lora/comparison_memory.png")
plt.close()
